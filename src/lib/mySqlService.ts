...
/**
 * This function creates a mySql service package
 ...
 * @param instances
 */
export function MySqlService(instances: Record<string, PoolConfig> | DefaultInstance<PoolConfig>): ServicePackage<PoolConfig,MySql.Pool,MySql.Connection> {
    return {
        [serviceName] : {
